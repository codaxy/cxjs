...
const onItemClick = (e, { store }) => {
   ...
   if (record.url) History.pushState({}, null, Url.resolve(record.url));
   else store.set("$topic.expanded", !record.expanded);
   return false;
};
...
export const SideNav = (
   <cx>
      ...
      >
         <div visible-expr="{$topic.$level} == 0" trimWhitespace={false} class="cxe-sidenav-topic">
