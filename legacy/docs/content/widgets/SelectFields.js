import {HtmlElement, Repeater, Select, Tab} from 'cx/widgets';
...
export const SelectFields = <cx>
    <Md>
        ...
        <CodeSplit>
            ...
            <Content name="code">
                <Tab value-bind="$page.code.tab" mod="code" tab="index" text="Select" default/>
                <CodeSnippet visible-expr="{$page.code.tab}=='index'" fiddle="hCnG2Ror">{`
                    <div layout={LabelsLeftLayout}>
                    <Select value-bind="$page.selection" label="Standard">
                        <option value={1}>Option 1</option>
                        <option value={2}>Option 2</option>
