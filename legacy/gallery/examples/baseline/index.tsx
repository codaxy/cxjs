...
import { Button, Checkbox, Menu, Section, Submenu, Switch, TextField } from "cx/widgets";

export default (
   <cx>
      <a
         href="https://github.com/codaxy/cx/tree/master/gallery/examples/baseline/index.tsx"
         target="_blank"
         putInto="github"
      >
         Source Code
      ...
      <Section mod="well" ws style="min-width: 918px;">
         <p>All widgets respect the baseline.</p>
