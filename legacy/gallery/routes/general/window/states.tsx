...
const showModal = (store) => {
  let modal = Window.create({
    ...
    items: (
      <cx>
        <p>
          Modal windows have a modal backdrop which prevents user from
          interacting with the contents on the page while the window is open.
        </p>
...
export default (
  <cx>
    ...
    <FlexRow wrap spacing="large" target="tablet" align="start">
      ...
      >
        <p>
          Windows with backdrop can be closed by clicking anywhere outside the
          window.
        </p>
      </Window>
