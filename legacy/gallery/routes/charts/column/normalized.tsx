import { CategoryAxis, Chart, Column, Gridlines, Legend, NumericAxis } from "cx/charts";
import { Svg } from "cx/svg";
import { bind, Controller, KeySelection, tpl } from "cx/ui";
import { Repeater, Section } from "cx/widgets";
...
export default (
   <cx>
      <a
         href="https://github.com/codaxy/cx/tree/master/gallery/routes/charts/column/normalized.tsx"
         target="_blank"
         putInto="github"
      >
         Source Code
      ...
      >
         <Svg style="width: 100%; flex: 1;">
            <Chart
               ...
               axes={{
                  x:
                     window.innerWidth >= mw
                        ? CategoryAxis
                        : { type: CategoryAxis, labelAnchor: "end", labelRotation: -45, labelDy: "0.35em" },
