...
The skill covers CxJS itself. Conventions specific to your application — shared components, API clients, routing helpers — belong in a project skill kept in your own repository; the [cxjs-skills repository](https://github.com/codaxy/cxjs-skills) includes a template to start from.
