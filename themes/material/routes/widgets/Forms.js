...
export default <cx>
   ...
   <Section mod="card" title="Dropdowns" style="flex:1 0 0%">
      <div layout={LabelsLeftLayout}>
         <Select label="Select" value:bind="radio" disabled style="width: 240px;">
            <option value={1}>Option 1</option>
            <option value={2}>Option 2</option>
         </Select>
         <LookupField label="LookupField" disabled value:bind="radio"
            options={options}
            style="width:100%;"/>
         <LookupField label="LookupField (multiple)" disabled multiple values:bind="options"
            options={options}
            style="width:100%;"/>
         <DateField label="DateField" disabled value:bind="date" style="width:100%"/>
         <MonthField label="MonthField" disabled range from:bind="dateFrom" to:bind="dateTo" style="width:100%"/>
         <ColorField label="ColorField" disabled value:bind="color" style="width:100%;"/>
      </div>
   </Section>
