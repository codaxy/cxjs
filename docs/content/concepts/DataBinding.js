import { Content, Checkbox, TextField, NumberField, Text, Slider, Tab } from 'cx/widgets';
...
export const DataBinding = <cx>
    <Md>
        ...
        > Suffix `-bind` is used on attributes to define two-way bindings.
        ...
        > Suffix `-expr` is used on attributes to define data expressions.
