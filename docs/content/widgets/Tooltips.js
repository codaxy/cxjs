import {HtmlElement, TextField, Checkbox, Grid, Tab, Content} from 'cx/widgets';
    ...
    <Md>
        <CodeSplit>
            ...
            <Content name="code">
                ...
                <CodeSnippet visible-expr="{$page.code.tab}=='controller'" fiddle="CGlqeBmC">{`
                class PageController extends Controller {
                init() {
                    super.init();
            ...
            `}</CodeSnippet>
                <CodeSnippet visible-expr="{$page.code.tab}=='index'" fiddle="CGlqeBmC">{`
