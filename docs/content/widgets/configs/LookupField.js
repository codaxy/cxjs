...
export default {
   ...
   valueTextField: {
      type: 'string',
      key: true,
      description: <cx><Md>Available only if `multiple` selection mode. Name of the field to store display text of the selected value.
   ...
   optionTextField: {
      type: 'string',
      key: true,
      description: <cx><Md>Name of the field which holds the display text of the option. Default value is `text`.</Md></cx>
   },
