import {HtmlElement, Button, Content, Tab} from 'cx/widgets';
    ...
    <Md>
        <CodeSplit>
            ...
            <Content name="code">
                ...
                <CodeSnippet visible-expr="{$page.code.tab}=='controller'" fiddle="Kc5LQhGG">{`
                class PageController extends Controller {
                    onInit() {
                        this.generate();
                        this.addComputable('$page.extremes', ['$page.points'], points => {
            ...
            `}</CodeSnippet>
                <CodeSnippet visible-expr="{$page.code.tab}=='index'" fiddle="Kc5LQhGG">{`
                <div class="widgets" controller={PageController}>
                    <Svg style="width:600px; height:400px;">
                        <Chart
                            offset="20 -10 -40 40"
