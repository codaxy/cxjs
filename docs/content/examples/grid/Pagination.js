import {HtmlElement, Grid, TextField, Select, Pagination, Tab, Content} from 'cx/widgets';
    ...
    <Md controller={PageController}>
        <CodeSplit>
            ...
            <Content name="code">
                ...
                <CodeSnippet visible-expr="{$page.code.tab}=='controller'" fiddle="eYVhlLNK">{`
                class PageController extends Controller {
                    init() {
                        super.init();
                ...
                `}</CodeSnippet>
                <CodeSnippet visible-expr="{$page.code.tab}=='index'" fiddle="eYVhlLNK">{`
