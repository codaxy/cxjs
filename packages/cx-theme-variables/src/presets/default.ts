...
export const defaultPreset: ThemeVariables = {
   ...
   labelFontSize: "calc(var(--cx-theme-font-size) - 1px)",
   ...
   checkboxSize: "16px",
   checkboxCheckedBackgroundColor: "var(--cx-theme-primary-color)",
   checkboxCheckedBorderColor: "var(--cx-theme-primary-color)",
   checkboxCheckedColor: "var(--cx-theme-primary-text-color)",
   radioCheckedColor: "var(--cx-theme-primary-color)",
   radioCheckedBorderColor: "var(--cx-theme-primary-color)",
   ...
   gridFontSize: "var(--cx-theme-font-size)",
   gridHeaderFontSize: "calc(var(--cx-theme-font-size) - 2px)",
   gridHeaderPaddingX: "var(--cx-input-padding-x)",
   gridHeaderPaddingY: "var(--cx-input-padding-y)",
   gridHeaderColor: "var(--cx-theme-text-color)",
   gridHeaderBackgroundColor: "var(--cx-button-background-color)",
   gridHeaderBorderColor: "var(--cx-theme-border-color)",
   ...
   cursorBoxShadow:
      "inset 0 0 0 var(--cx-cursor-border-width) var(--cx-cursor-color)",

   listItemPaddingX: "calc(var(--cx-input-padding-y) * 1.5)",
   listItemPaddingY: "calc(var(--cx-input-padding-y) * 1.5)",
   ...
   toastBoxShadow: "var(--cx-overlay-box-shadow)",
   ...
   windowFontSize: "var(--cx-theme-font-size)",
   ...
   tooltipFontSize: "var(--cx-theme-font-size)",
   tooltipPadding: "var(--cx-button-padding-y)",
   tooltipBoxShadow: "var(--cx-overlay-box-shadow)",
   ...
   monthPickerCellPadding:
      "var(--cx-input-padding-y) var(--cx-input-padding-x)",
   monthPickerCellLineHeight: "var(--cx-input-line-height)",
   monthPickerFontSize: "var(--cx-theme-font-size)",
   ...
   calendarDayFontSize: "var(--cx-theme-font-size)",
};
