...
describe("babel-plugin-transform-cx-imports", function () {
   ...
   it("imports Cx widgets from source", function () {
      ...
      assert.equal(unwrap(output), 'import { TextField } from "cx/widgets/form/TextField.js"');
   });

   it.skip("imports scss file if available and option is set", function () {
      let code = `import {TextField} from "cx/widgets"`;
      ...
      assert.deepEqual(lines(output), [
         'import { TextField } from "cx/widgets/form/TextField.js";',
         'import "cx/widgets/form/TextField.scss"',
      ]);
   });
   ...
   it("imports multiple things from source", function () {
      ...
      assert.deepEqual(lines(output), [
         'import { Text } from "cx/ui/Text.js";',
         'import { TextField } from "cx/widgets/form/TextField.js"',
      ]);
   });
});
