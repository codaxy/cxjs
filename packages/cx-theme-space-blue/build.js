...
async function build() {
   try {
      ...
      return Promise.all([
         ...
         buildSCSS([themeSrc("reset.scss")], theme("dist/reset.css")),
         buildSCSS([themeSrc("widgets.scss")], theme("dist/widgets.css")),
         buildSCSS([themeSrc("charts.scss")], theme("dist/charts.css")),
         buildSCSS([themeSrc("svg.scss")], theme("dist/svg.css"))
      ]);
   } catch (err) {
      console.error(err);
   }
