...
export type HtmlElementConfig<
  Tag extends keyof ReactIntrinsicElements = "div",
> = Omit<HtmlElementConfigBase, "tag"> &
  TransformHtmlElementProps<ReactIntrinsicElements[Tag]> & { tag?: Tag };

export class HtmlElementInstance<
    E extends HtmlElement<any, any> = HtmlElement<any, any>,
  >
  extends Instance<E>
...
> extends StyledContainerBase<Config, InstanceType> {
  ...
  declare public events?: Record<
    string,
    (e: Event, instance: Instance) => unknown
  >;
  declare public urlAttributes?: string[];
  declare public extraProps?: Record<string, unknown>;
  declare public tooltip?: TooltipProp;
  declare public onRef?:
    | string
    | ((element: HTMLElement | null, instance: Instance) => void);
    ...
    if (this.urlAttributes && data.attrs) {
      ...
      this.urlAttributes.forEach((attr: string) => {
        ...
        if (isString(attrValue)) {
          (data.attrs as Record<string, unknown>)[attr] =
  ...
  render(
    ...
    if (this.events && !instance.events) {
      ...
      for (const eventName in this.events) {
        ...
        instance.events[eventName] = (e: React.SyntheticEvent) =>
