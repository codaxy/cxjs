...
import { ConfigureOverlayContainerContext, Overlay, OverlayBase, OverlayConfig, OverlayInstance } from "./Overlay";
...
> extends OverlayBase<Config, InstanceType> {
   ...
   getConfigureOverlayContainerContext(instance?: DropdownInstance): ConfigureOverlayContainerContext {
      return {
