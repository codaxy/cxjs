...
export class OpenDialogController extends Controller {
   init() {
      ...
      if (!this.store.get("user.email") || !this.store.get("open.tab")) this.store.set("open.tab", "popular");

      this.addTrigger(
         "pageReset",
         ["open.tab", "$modal.query"],
         () => {
      ...
      this.addTrigger(
         "load",
         ["open.tab", "$modal.page", "$modal.query"],
         (list, page, query) => {
   ...
   var dialog = (
      <cx>
         ...
         >
            ...
            <FlexRow>
               <Pagination
                  page:bind="$modal.page"
                  pageCount:bind="$modal.pageCount"
