...
function importTheme(theme) {
  switch (theme) {
    ...
    case "aquamarine":
      return import(
        /* webpackChunkName: 'aquamarine' */ "../themes/aquamarine"
      );

    case "material-dark":
      return import(
        /* webpackChunkName: 'material-dark' */ "../themes/material-dark"
      );

    case "space-blue":
      return import(
        /* webpackChunkName: 'space-blue' */ "../themes/space-blue"
      );
  }
}

export const ThemeLoader = createFunctionalComponent(({ theme, children }) => (
  <cx>
    <ContentResolver
      params={theme}
      onResolve={theme => {
