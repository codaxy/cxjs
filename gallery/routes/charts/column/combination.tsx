...
import { bind, Controller, expr, KeySelection, tpl } from "cx/ui";
import { FlexRow, Grid, Repeater, Section } from "cx/widgets";
...
export default (
   <cx>
      <a
         href="https://github.com/codaxy/cx/tree/master/gallery/routes/charts/column/combination.tsx"
         target="_blank"
         putInto="github"
      >
         Source Code
               ...
               >
                  ...
                  <Repeater records={bind("$page.points2")} recordName="$point">
                     ...
                     <Marker
                        ...
                        draggableY
                     >
                        <Rectangle anchors="0 1 0 0" offset="-30 10 -10 -10" mod="cover">
