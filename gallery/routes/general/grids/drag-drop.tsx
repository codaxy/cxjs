...
import { DragHandle, FlexRow, Grid, Section } from "cx/widgets";
...
export default (
   <cx>
      <a
         href="https://github.com/codaxy/cx/tree/master/gallery/routes/general/grids/drag-drop.tsx"
         target="_blank"
         putInto="github"
      >
         Source Code
      ...
      <FlexRow target="tablet" wrap controller={PageController} spacing="large">
         ...
         <Section mod="well" title="Row Handle" hLevel={4}>
            <Grid
               ...
               dragSource={{ mode: "copy", data: { type: "record", source: "grid2" } }}
