      ...
      <div>
         ...
         <FlexRow wrap spacing="xlarge" pad="xlarge">
            ...
            <FlexRow style="height: 200px; width: 200px; border:1px solid gray" pad>
               <div style="flex: 1; background: yellow;">pad</div>
               <div style="flex: 1; background: green"></div>
            </FlexRow>
            ...
            <FlexRow style="height: 200px; width: 200px; border:1px solid gray" pad spacing>
               <div style="flex: 1; background: yellow;">pad</div>
               <div style="flex: 1; background: green">spacing</div>
            </FlexRow>
         ...
         <FlexRow wrap spacing="xlarge" pad="xlarge" align="start">
            <FlexRow style="width: 200px; border:1px solid gray">
               <div style="flex: 1; background: yellow; height: 100px">flex: 1</div>
               <div style="flex: 1; background: green; height: 200px">flex: 1</div>
            </FlexRow>

            <FlexCol style="width: 200px; border:1px solid gray">
               <div style="background: yellow; height: 100px">flex: 1</div>
               <div style="background: green; height: 100px">flex: 1</div>
            </FlexCol>
         </FlexRow>
      </div>
   </cx>
