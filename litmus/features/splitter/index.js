import {FlexRow, FlexCol, Splitter} from "cx/widgets";
...
export default <cx>
   <FlexCol style="height: 100%; padding: 5px;">
      <FlexRow style={{
         ...
         <Splitter forNextElement value-bind="rightWidth"/>
         <div style={{
      ...
      <Splitter value-bind="height" horizontal />
      <FlexRow style="flex: 1 1 0">
         ...
         <Splitter value-bind="width"/>
         <div style="border: 1px solid red; flex: 1 1 0;"/>
         <Splitter forNextElement value-bind="rightWidth2"/>
         <div style={{
