...
class PageController extends Controller {
   onInit() {
      ...
      this.addTrigger("points", ['count'], count => {
         this.store.set(
            "points",
   ...
   <cx>
      <div class="widgets" controller={PageController} style="padding: 20px">
         ...
         <div>
            ...
            <LabelsTopLayout>
               <Slider value-bind="count" help-tpl="{count} points" increment={1} step={1} minValue={1} maxValue={50} label="Points" />
               <Slider value={{ bind: "distance", defaultValue: 100 }} help-tpl="{distance:n;0}px" minValue={0} maxValue={500} label="Distance" />
            </LabelsTopLayout>
         </div>
      </div>
   </cx>
